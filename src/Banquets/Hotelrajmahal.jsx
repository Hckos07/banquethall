    ...
    <>
      ...
      <div className="max-w-full mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6">
          ...
          <h2 className="text-2xl font-bold mt-2">
            Hotel Rajmahal, New Industrial Town, Faridabad
          </h2>
          <p className="text-gray-600 mt-1">
            Hotel Rajmahal, NIT, 46, B.P. Neelam Bata Road, Shahid Bhagat Singh Marg, near Neelam Cinema, AC Nagar, Faridabad, Haryana 121001{" "}
          </p>
      ...
      <div className="my-auto mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <p className="text-gray-700 mb-2">
          Hotel Rajmahal, Faridabad, will shoo away all your event woes. With a range of banquets on offer for indoor events, you are in good hands here.
          {showMore && (
            <span>
              Hotel Rajmahal offers multiple spacious banquet halls that can accommodate hundreds of guests. With the option to choose from any of these party areas, you can pick one depending on your event requirement and the size of your guest list. To know more about the party areas, booking, and Hotel Rajmahal prices, you can give us a call at the contact number mentioned on this page.
            </span>
          )}
          <button
        ...
        <div className="flex items-center space-x-3 mt-4">
          <span className="text-lg font-semibold">Call Hotel RajMahal</span>
      ...
      <div className="p-6 bg-gray-50">
        ...
        <p className="text-gray-700 mb-4">
          Hotel Rajmahal, NIT, 46, B.P. Neelam Bata Road, Shahid Bhagat Singh Marg, near Neelam Cinema, AC Nagar, Faridabad, Haryana 121001
          <a
            href="https://www.google.co.in/maps/place/Hotel+Rajmahal/@28.3860743,77.3047341,17z/data=!4m9!3m8!1s0x390cdc72d3a41b7d:0xb75e706af0f3058e!5m2!4m1!1i2!8m2!3d28.3860743!4d77.307309!16s%2Fg%2F1xn_lsb1?entry=ttu&g_ep=EgoyMDI1MDMxNy4wIKXMDSoASAFQAw%3D%3D"
            target="_blank"
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Google Maps Embed for Hotel Rajmahal, Faridabad */}
          <div className="rounded-lg overflow-hidden border shadow-lg">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d876.5418229676659!2d77.3047341!3d28.3860743!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cdc72d3a41b7d%3A0xb75e706af0f3058e!2sHotel%20Rajmahal!5e0!3m2!1sen!2sin!4v1710172592489"
            ></iframe>
          </div>
      ...
      <div className="my-auto mx-auto mt-7 pb-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <p className="text-gray-700 mb-2">
          The popular Hotel Rajmahal, Faridabad, New Industrial Town, makes for a fantastic event venue. With multiple fabulous banquet halls, the wedding hotel is ideal for hosting a range of social,
          {showMore && (
            <span>
              corporate, as well as wedding and pre-wedding events. The decor and catering for your event will be covered by the in-house experts and you also get to enjoy other perks like lodging facilities and a couple of complimentary changing rooms.
            </span>
          )}
          <button
            onClick={() => setShowMore(!showMore)}
      ...
      <div className="p-6 bg-white">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-gray-800">
          <ul className="space-y-3">
            ...
            <li>• Located around 4 km away from Bata Chowk Metro Station</li>
          </ul>
          <ul className="space-y-3">
            <li>• Banquet hall in Faridabad perfect for weddings and events</li>

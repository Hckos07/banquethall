    ...
    <>
      ...
      <div className="max-w-full mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 mt-1">
            Sarovar Portico, Block C, Lal Kuan, Surajkund, Faridabad, New Delhi, Haryana 121009
          </p>
          ...
          <div className="mt-6 bg-gray-100 p-4 rounded-lg">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <span className="text-gray-900">
                <s className="text-red-500 text-xl">₹2200</s> /Plate
              </span>
            </div>
            <div className="flex justify-between items-center mt-2">
              <span className="text-gray-700">🍗 Non-Vegetarian</span>
              <span className="text-gray-900">
                <s className="text-red-500 text-xl">₹2400</s> /Plate
              </span>
            </div>
          </div>
      ...
      <div className="my-auto mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <p className="text-gray-700 mb-2">
          Experience the perfect blend of elegance and comfort at Sarovar Portico Faridabad Surajkund, a premier destination in the city known for its impeccable hospitality and world-class amenities. It 
          {showMore && (
            <span>
              imbibes that welcoming vibe that we all look for while booking a hotel for weddings, social events, and family functions.
              <p>
                Sarovar Portico Hotel, Faridabad, checks all the boxes of a great venue to host pretty little cocktail parties, kitty parties, product launches, glamorous birthday parties, pre-wedding ceremonies such as haldi, mehndi, sangeet, engagement ceremony, weddings, regal receptions, social gatherings, and corporate events such as board meetings, business meets, conferences, seminars, workshops, team-building activities, family get-togethers, private events, and a lot more.</p>
            </span>
          )}
          <button
        ...
        <div className="flex items-center space-x-3 mt-4">
          <span className="text-lg font-semibold">Call Sarovar Portico</span>
      ...
      <div className="p-6 bg-gray-50">
        ...
        <p className="text-gray-700 mb-4">
          Sarovar Portico Surajkund, Faridabad, Haryana 121009
          <a
            href="https://www.google.co.in/maps/place/Sarovar+Portico+Surajkund/@28.4895252,77.2809296,17z/data=!3m1!4b1!4m9!3m8!1s0x390ce185145d0a6f:0x5f39da52ecd967d6!5m2!4m1!1i2!8m2!3d28.4895252!4d77.2835045!16s%2Fg%2F11fp1p5wd2?entry=ttu&g_ep=EgoyMDI1MDMxOC4wIKXMDSoASAFQAw%3D%3D"
            target="_blank"
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Google Maps Embed for Sarovar Portico Surajkund, Faridabad */}
          <div className="rounded-lg overflow-hidden border shadow-lg">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4385.345203442976!2d77.2809296!3d28.4895252!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce185145d0a6f%3A0x5f39da52ecd967d6!2sSarovar%20Portico%20Surajkund!5e0!3m2!1sen!2sin!4v1710172592489"
            ></iframe>
          </div>
      ...
      <div className="my-auto mx-auto mt-7 pb-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <p className="text-gray-700 mb-2">
          The first choice of all leisure and business class travelers, Sarovar Portico is a premium property located at a very prime spot in Faridabad. It has a few banquet halls that could be used to host all
          {showMore && (
            <span>
              your cozy events with all your loved ones. The venue makes sure all your catering, decor alcohol and accommodation-related needs are well taken care of.
            </span>
          )}
          <button
            onClick={() => setShowMore(!showMore)}
      ...
      <div className="p-6 bg-white">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-gray-800">
          <ul className="space-y-3">
            <li>• Modern stay, ample parking space, and valet services</li>
            <li>• Located 4 km away from the Tughlakabad Railway Station</li>
          </ul>
          <ul className="space-y-3">
            <li>• Multiple banquet halls and a wedding lawn perfect for small to large events</li>
            <li>• Experienced in-house caterers and decorators handle events needs</li>
          </ul>
        </div>
      </div>
      ...
      <div className="p-6 bg-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-4">
            ...
            <p className="text-gray-700"><strong>Morning:</strong> 10:00 AM - 3:00 PM</p>
          ...
          <div className="bg-white p-4 ">
            ...
            <p className="text-gray-700"><strong>No. of rooms:</strong> 40</p>
            <p className="text-gray-700"><strong>Average price per room:</strong> Rs. 4000/-</p>
          </div>
          ...
          <div className="bg-white p-4 ">
            ...
            <p className="text-gray-700">Parking space for 250 vehicles</p>
          </div>
